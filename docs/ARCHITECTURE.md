...
**Pending decision:** whether admin self-registration requires super_admin approval prior to activation. To be finalized ahead of the auth implementation.

## 2. Authentication

- **Admin / super admin:** Laravel Sanctum, SPA cookie-based session auth between the React client and Laravel API.
